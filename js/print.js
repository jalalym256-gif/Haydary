        ...
        ">
            ...
            <div style="padding:20px 25px; display:flex; flex-direction:column; gap:16px;">
                ...
                <div style="display:flex; flex-direction:column; gap:8px;">
                    ...
                    <input type="text" id="psShopName" value="${escapeHtml(s.shopName || '')}" placeholder="مثال: خیاطی حیدری"
...
<body>
    <div class="invoice">
        <div class="header">
            <div class="logo">${cfg.shopName ? escapeHtml(cfg.shopName) : 'حیدری خیاطی'}</div>
            <div class="contact">۰۷۹۵۷۵۹۰۰۶</div>
        </div>
        ...
        <div class="thank-you">
            ...
            <div class="brand">${cfg.shopName ? escapeHtml(cfg.shopName) : 'برند حیدری'}</div>
        </div>
    </div>
